...
import java.io.*;
import java.sql.*;
public class LIBStandardServlet extends HttpServlet {
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("Librarystory.jsp?BODY_PATH=Standard.jsp");
    ...
    private LIBList readDB(int upperid) throws ServletException {     
        ...
        try {
			...
			ResultSet rs = stmt.executeQuery("select * from userlibrary where id < " + upperid + " order by number desc;");
