...
import java.io.*;
import java.sql.*;
public class LIBAbleBookServlet extends HttpServlet {
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("Librarystory.jsp?BODY_PATH=AbleBook.jsp");
    ...
    private LIBList readDB(int upperid) throws ServletException {     
        ...
        try {
			...
			ResultSet rs = stmt.executeQuery("select * from userlibrary where lend = 1  " + " order by id asc;");
